    ...
    <div className="flex flex-col p-8 sm:p-12">
      ...
      <div className="mb-10 flex flex-col items-center">
        <div className="flex items-center gap-2.5 mb-8">
          ...
          <span className="text-xl font-clash font-semibold tracking-wide text-navy">Money Manager</span>
        </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-sm font-medium text-navy ml-1" htmlFor="email">Email Address</label>
        ...
        {/* Password Field */}
        <div className="flex flex-col gap-1.5">
          <label className="text-sm font-medium text-navy ml-1" htmlFor="password">Password</label>
          <div className="group relative flex w-full items-center rounded-lg border border-border-light bg-white transition-all duration-200 focus-within:border-terracotta focus-within:ring-1 focus-within:ring-terracotta">
            <div className="pointer-events-none flex h-full w-12 items-center justify-center text-slate-400 transition-colors group-focus-within:text-terracotta">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 pt-1">
          ...
          <a className="text-sm font-medium text-terracotta hover:text-terracotta-light transition-colors" href="#">
            Forgot password?
          </a>
        </div>
      ...
      <div className="relative mt-8 flex items-center py-2">
        ...
        <span className="mx-4 flex-shrink-0 text-xs font-medium text-slate-400 tracking-wider">OR</span>
        <div className="flex-grow border-t border-slate-200"></div>
      </div>
      ...
      <p className="mt-8 text-center text-sm text-slate-500">
        ...
        <Link to="/register" className="font-semibold text-terracotta hover:text-terracotta-light hover:underline decoration-2 underline-offset-2 transition-all">
          Sign Up
        </Link>
      </p>
    </div>
