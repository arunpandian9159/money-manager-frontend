...
const Home = () => {
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden font-serif bg-[#F9F8F4] text-[#0A192F] antialiased selection:bg-[#D65A31] selection:text-white">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-[#0A192F]/5 bg-[#F9F8F4]/80 backdrop-blur-md">
        <div className="px-6 md:px-12 py-4 mx-auto max-w-7xl flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-[#0A192F] font-display text-lg font-bold tracking-tight uppercase">
              Money Manager
            </h2>
          </div>
          <nav className="hidden md:flex items-center gap-12">
            <a
              className="text-[#0A192F]/70 hover:text-[#D65A31] transition-colors font-serif text-lg italic"
              href="#features"
            >
              Features
            </a>
          ...
          <div className="flex gap-4 items-center">
            <Link
              to="/login"
              className="hidden sm:block font-mono text-sm text-[#0A192F] uppercase tracking-widest hover:text-[#D65A31] transition-colors"
            >
              Log In
            </Link>
            <Link
              to="/register"
              className="bg-[#0A192F] text-white hover:bg-[#D65A31] font-mono text-xs uppercase tracking-widest px-6 py-3 transition-colors"
            >
              Get Access
            </Link>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
            <div className="w-full lg:w-[55%] flex flex-col gap-8 relative z-10">
              <div className="flex items-center gap-4">
                ...
                <span className="font-mono text-[#D65A31] uppercase tracking-widest text-sm">
                  Fintech Refined
                </span>
              </div>
              <h1 className="font-display text-[#0A192F] text-6xl sm:text-7xl xl:text-8xl font-black leading-[0.9] tracking-tight">
                Capitalize <br />
                <span className="font-serif italic font-light text-5xl sm:text-6xl xl:text-7xl block mt-2 mb-2">
                  on
                </span>
                Clarity
              </h1>
              ...
              <div className="pt-8 flex flex-col sm:flex-row gap-6">
                <Link
                  to="/register"
                  className="bg-[#D65A31] text-white hover:bg-[#0A192F] font-display font-bold text-sm uppercase tracking-widest px-10 py-4 transition-all shadow-xl shadow-[#D65A31]/20 text-center"
                >
                  Start Trial
                </Link>
              ...
              <div className="relative z-10">
                <div className="relative bg-white border border-[#0A192F]/10 shadow-2xl shadow-[#0A192F]/20 p-2 rounded-lg aspect-[4/3] overflow-hidden">
                  <div className="w-full h-full bg-[#ECEBE6]/30 rounded flex flex-col overflow-hidden">
                    <div className="h-12 border-b border-[#0A192F]/5 flex items-center px-4 justify-between bg-white">
                      ...
                      <div className="font-mono text-[10px] text-[#0A192F]/40">
                        DASHBOARD_V2.0
                      </div>
                    </div>
                    <div className="flex-1 bg-gradient-to-br from-[#F9F8F4] to-[#ECEBE6] flex items-center justify-center">
                      <span className="material-symbols-outlined text-8xl text-[#0A192F]/10">
                        dashboard
                      </span>
                    </div>
                  </div>
                ...
                <div className="absolute -left-8 bottom-12 bg-[#F9F8F4] border border-[#0A192F]/10 p-5 shadow-xl w-56">
                  <div className="flex justify-between items-end mb-2">
                    ...
                    <span className="font-mono text-xs text-[#81B29A]">
                      +12.4%
                    </span>
                  </div>
        ...
        <div className="mx-auto max-w-[1400px]">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-[#0A192F]/10">
            <div className="p-8 group hover:bg-[#ECEBE6] transition-colors">
              <p className="font-mono text-xs uppercase tracking-widest text-[#0A192F]/50 mb-2 group-hover:text-[#D65A31] transition-colors">
                Saved Weekly
              </p>
              <p className="font-mono text-4xl md:text-5xl font-bold text-[#0A192F] tracking-tighter">
                $2.4k
              </p>
            </div>
            <div className="p-8 group hover:bg-[#ECEBE6] transition-colors">
        ...
        <div className="mx-auto max-w-[1400px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-6">
            <div className="md:col-span-6 lg:col-span-7 bg-white p-8 md:p-12 border border-[#0A192F]/5 shadow-sm hover:shadow-xl transition-shadow duration-500 group min-h-[400px] flex flex-col justify-between">
              ...
              <div>
                <h3 className="font-display text-3xl md:text-4xl font-bold text-[#0A192F] mb-4">
                  Smart Ledger
                </h3>
            ...
            <div className="md:col-span-3 lg:col-span-4 bg-[#81B29A]/20 p-8 border border-[#81B29A]/20 hover:bg-[#81B29A]/30 transition-colors flex flex-col justify-center items-center text-center gap-4 min-h-[250px]">
              <span className="material-symbols-outlined text-5xl text-[#0A192F]">
                pie_chart
              </span>
              <h4 className="font-display font-bold text-xl text-[#0A192F] uppercase tracking-wide">
                Visual Analytics
              </h4>
            </div>
            <div className="md:col-span-3 lg:col-span-4 bg-[#D65A31]/10 p-8 border border-[#D65A31]/20 hover:bg-[#D65A31]/20 transition-colors flex flex-col justify-center items-center text-center gap-4 min-h-[250px]">
              <span className="material-symbols-outlined text-5xl text-[#D65A31]">
                lock_clock
              </span>
              <h4 className="font-display font-bold text-xl text-[#0A192F] uppercase tracking-wide">
                12-Hour Edit Window
      ...
      <section
        id="methodology"
        className="py-32 bg-[#ECEBE6] relative overflow-hidden"
      >
        <div
        ...
        <div className="mx-auto max-w-6xl px-6 relative z-10">
          <h2 className="text-center font-display text-4xl md:text-5xl font-bold text-[#0A192F] mb-24 uppercase">
            The Methodology
          </h2>
          <div className="space-y-16">
            {[
              ...
              >
                ...
                >
                  <div className="font-mono text-[#D65A31] text-sm mb-2">
                    PHASE {item.phase}
                  </div>
                  <h3 className="font-display text-3xl font-bold text-[#0A192F] mb-4">
                    {item.title}
                  </h3>
                  <p className="font-serif text-lg text-[#0A192F]/70 max-w-sm">
                    {item.desc}
                  </p>
                </div>
      ...
      <section
        id="testimonial"
        className="py-32 px-6 bg-white border-y border-[#0A192F]/5"
      >
        <div className="max-w-4xl mx-auto text-center">
          <span className="material-symbols-outlined text-6xl text-[#D65A31]/20 mb-8">
            format_quote
          </span>
          ...
          <div className="flex flex-col items-center gap-2">
            <cite className="font-display font-bold text-[#0A192F] text-lg not-italic uppercase tracking-widest">
              The Financial Review
            </cite>
            <span className="font-mono text-sm text-[#0A192F]/40">
              Quarterly Issue, 2023
            </span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
            <div className="col-span-1 md:col-span-2 lg:col-span-1">
              ...
              <Link
                to="/register"
                className="inline-block bg-[#D65A31] hover:bg-white hover:text-[#0A192F] text-white font-mono text-xs uppercase tracking-widest px-6 py-3 transition-colors"
              >
                Get App
              </Link>
            </div>
            <div>
              <h4 className="font-mono text-[#D65A31] text-xs uppercase tracking-widest mb-6">
                Platform
              </h4>
