...
const navItems = [
  { path: '/app/dashboard', label: 'Dashboard', icon: 'dashboard', filled: true },
    ...
    <aside className="w-[280px] h-full bg-white dark:bg-[#1a2332] border-r border-[#f0f2f4] dark:border-gray-800 flex flex-col shrink-0 transition-all duration-300 z-20">
      ...
      <div className="p-6 pb-2">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-[#617089] dark:text-gray-400 text-xs font-medium leading-normal pl-10">Financial App</p>
        </div>
      </div>
